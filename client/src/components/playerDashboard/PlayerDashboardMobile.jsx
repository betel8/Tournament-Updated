...
import { UserOutlined, LockOutlined, BarChartOutlined, ClockCircleOutlined } from '@ant-design/icons';
import { Suspense } from 'react';

export default function PlayerDashboardMobile({ activeTab, setActiveTab, tabItems }) {
